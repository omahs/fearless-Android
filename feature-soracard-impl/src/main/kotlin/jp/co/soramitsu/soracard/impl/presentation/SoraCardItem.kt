...
data class SoraCardItemViewState(
    ...
    companion object {
        val default = SoraCardItemViewState("Get SORA card", null, false)
    }
}
...
private fun SoraCardItemItemPreview() {
    Column {
        val state = SoraCardItemViewState(null, "2455", false)
        SoraCardItem(state = state, {}, {})
        MarginVertical(margin = 8.dp)
        val state2 = SoraCardItemViewState("Get SORA card", null, false)
